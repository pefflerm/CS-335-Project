...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Load the logo image
        ImageIcon logoIcon = new ImageIcon(Main.class.getResource("/cs335_package/image/C.png"));
        ...
        // --- Authentication Flow --- added by nada
        // //https://www.youtube.com/watch?v=gBtuj_MjgtY&themeRefresh=1 soruce
        ...
        for (String x : category) {
            ...
            switch (x) {
                ...
                case "Skincare/Haircare":
                    ...
                    break;
                default:
                    // The "Other" category is populated by Yelp search later, so no need to load
                    // here
                    break;
            } // switch statement
        } // for loop
        ...
        while (true) { // Changed to an infinite loop, will exit when frame is closed or exit button is
                       // pressed
            ...
            if (s.equals("VIEW_WISHLIST")) {
                System.out.println(
                        "User selected VIEW_WISHLIST. Opening WishlistViewerGUI for user: " + loggedInUsername);
            ...
            if (!s.equals("VIEW_WISHLIST") && !s.equals("VIEW_ALL_RESTAURANTS") && !s.equals("Go Back")
                    && !s.isEmpty()) {
                ...
                while (locIndex < currentCategoryList.size()) {
                    ...
                    switch (choice) {
                        case 3:
                            ...
                            // The action (add to wishlist and confirmation message) happens inside the
                            // dialog
                ...
                if (!s.equals("Go Back")) {
                    // If the inner loop finished without going back, it means all locations in the
                    // category were viewed
                ...
                if (currentPlace != null && startIndex != -1) {
                    System.out.println("Location selected from list viewer: " + currentPlace.getName() + " at index "
                            + startIndex);
                    ...
                    System.out.println(
                            "No location selected from list viewer or selection cancelled. Returning to main menu.");
    ...
    public static String getCsvFile(String category) {
        switch (category) {
            ...
            default:
                return "GeneralRecommendations.csv"; // Fallback file
        }
    } // getCsvFile function
    ...
    public static void newGenRecs() {
        // function to delete whatever entries are in the General Recommendations CSV
        // from previous user
