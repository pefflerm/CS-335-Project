            ...
            if(s!=null){
                ...
                if(!s.isEmpty()){
                    ...
                    if (wish.equals("yes")) {
                        ...
                        System.out.println("Would you like to schedule a time to visit " + place.getName() + "? (yes/no)");
						...
						System.out.println("Location not added to wishlist.");
					}
